    ...
    <section class="bg-[#1e3a8a] text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl font-bold mb-4">Need help? Get in touch with us</h2>
                    <p class="text-blue-100 mb-6">Our support team is here to assist you with any issues or questions you may have. Reach out to us and we'll respond as soon as possible.</p>
                    <a href="contact.html" class="inline-block bg-[#fbbf24] text-[#1e3a8a] font-semibold py-2 px-4 rounded hover:bg-[#f59e0b] transition duration-300">Contact Support</a>
                </div>
                <div>
                    <img src="assets/img/support-team.svg" alt="Support Team" class="w-full h-auto">
                </div>
            </div>
        </div>
    </section>
